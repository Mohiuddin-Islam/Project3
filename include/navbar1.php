            ...
            <nav class="main-menu">
                <div class="container">
                    ...
                    <ul class="main-menu__list">
                        ...
                        <!-- <li class="dropdown"><a href="">Mohiuddin</a></li> -->
                        <li class="dropdown"><a style="background-color: green;" class="text-white text-decoration-none btn btn-primary py-1 m-0" href="signup.php">Sign Up</a></li>
                        <li class="dropdown"><a style="background-color: green-wood;" class="text-white text-decoration-none btn btn-primary py-1 m-0" href="login.php">Login</a></li>
